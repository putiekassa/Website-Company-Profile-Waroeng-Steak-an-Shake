          ...
          <div class="line margin-bottom-80">
             <div class="margin"><br><br>
					...
					<h5><center><b><?php echo $data['judul'];?></b></center></h5>	
							<hr>
							<center><img class="img-responsive img-border" src="<?php echo "admin/images/".$data['foto'];?>" alt=""/>
							<br>
							<span align=" justify">	<?php  echo $potong_text;?>
							<br><a href="berita_detail.php?id=<?php echo $id;?>"></a>  
							</div>
							<?php
							}
							?>
