...
include "admin/sistem/koneksi.php";
	$id = $_GET ['id'];
	$query = "SELECT * FROM tb_new WHERE id=$id"; // Query untuk menampilkan semua data siswa
          ...
          <div class="line margin-bottom-60">
            <div class="margin"><br><br>
							<div class="s-12 m-12 l-4">
								<h2><center><b><?php echo $data['judul'];?></b></center></h2>
								<hr>
								</div>
								<center><img class="img-responsive img-border" src="<?php echo "admin/images/".$data['gambar'];?>" /></center>
								<span align=" justify">	<?php echo $data['isi'];?></span>	
