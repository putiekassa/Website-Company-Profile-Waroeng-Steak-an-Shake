      ...
      <!-- Main row -->
            ...
            <div class="box-body">
              <form action="sistem/simpan_index.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                  <textarea class="textarea" name="isi" placeholder=" Masukkan Isi" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                </div>
